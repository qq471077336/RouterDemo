...
public interface ProcessorConfig {
    ...
    // @ARouter注解 的 包名 + 类名
    String ROUTER_PACKAGE =  "com.lwd.router_annotations.Router";
    String PARAMETER_PACKAGE =  "com.lwd.router_annotations.Parameter";
    ...
    // ARouter api 包名
    String AROUTER_API_PACKAGE = "com.lwd.router_api";

    // ARouter api 的 ARouterGroup 高层标准
    String AROUTER_API_GROUP = AROUTER_API_PACKAGE + ".RouterGroup";

    // ARouter api 的 ARouterPath 高层标准
    String AROUTER_API_PATH = AROUTER_API_PACKAGE + ".RouterPath";
